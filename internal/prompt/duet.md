...
### 2. ネーム（dialogue）の執筆ルール

VOICEVOXエンジンが最高の発話を行えるよう、以下のフォーマットを**厳守**してください。

* **フォーマット**: `[話者タグ][スタイルタグ] [演出タグ] セリフ`
* **重要**: タグ間およびテキストとの間には、**必ず半角スペースを一つ**入れること。
  ...
  "pages": [
    {
      ...
      "dialogue": "[めたん][ノーマル] [解説] さあ、私と一緒に{{.InputText}}の神秘を解き明かしていきましょう。"
    },
    {
      "page": 2,
      "speaker_id": "zundamon",
      ...
      "dialogue": "[ずんだもん][ノーマル] [解説] これが今回の核心部分なのだ！ボクが構造をじっくり説明してやるのだよ。"
    }
  ]
}
